...
namespace Unity.Game.Utilities
{
    public static class DebugUtility
    {
        ...
        public static void HandleErrorIfNullInputActionProperty<TS>(InputActionProperty input, Component source,
            GameObject onObject)
        {
#if UNITY_EDITOR
            ...
            {
                Debug.LogError("Error: Component of type " + typeof(TS) + " on GameObject " + source.gameObject.name +
                               " expected to find a component of type InputActionProperty" + " on GameObject " +
                               onObject.name + ", but none were found.");
            }
#endif
        }
